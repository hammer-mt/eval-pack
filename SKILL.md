...
**Keep the pack small: aim for ≤8–10 slides.** The pack's value is that it reviews in minutes; every extra slide taxes that. Merge related changes onto one slide, cut what a one-line mention covers, and prefer one decisive capture over three overlapping ones.
